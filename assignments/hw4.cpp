...
2. displayArea()
    2-1. displayArea() displays the area (as a float value) of the corresponding object.
...
public:
    explicit Circle(int _d) : Shape(_d) {
        area = (float)PI * _d * _d;
    }

    void displayArea() override {
        cout << "\nType: Circle, Area: " << area << endl;
    }
...
public:
    explicit Rectangle(int _d) : Shape(_d) {
        area = float(_d * _d);
    }

    void displayArea() override {
        cout << "\nType: Rectangle, Area: " << area << endl;
    }
